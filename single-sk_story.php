...
<article class="sk-story-single" id="story-<?php echo $id; ?>">
  ...
  <div class="sk-story-single__cover">
    <img src="<?php echo esc_url( $cover ); ?>" alt="<?php echo esc_attr( get_the_title() ); ?>" loading="eager" />
  ...
  <header class="sk-story-single__header">
    <div class="wrap-narrow">
      ...
      <div class="sk-story-single__byline">
        ...
        <span class="sk-story-author-location"><?php echo esc_html( $author_location ); ?></span>
        <?php endif; ?>
        <?php if ( $author_title ) : ?>
